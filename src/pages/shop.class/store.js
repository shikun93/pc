...
var Store =  Reflux.createStore({
    ...
    onGetList:function(token,page,cb){
        ...
        fetch(urlhttp+"/admin.shop_store_class/getlist",{method:"post",body:obj})
    ...
    onAddShopGrade:function(token,values,Actions,cb){
        ...
        let obj = new FormData();
        obj.append("admin_token",token);
        obj.append("store_class_name",values["store_class_name"]);
        obj.append("store_class_bail",values["store_class_bail"]);
        obj.append("sort_order", values["sort_order"]);
        fetch(urlhttp+"/admin.shop_store_class/addone",{method:"post",body:obj})
            .then(function(response){
                return response.json();
            }).then(function(result){
                if(result.error == ""){
    ...
    onGetEditorList:function(token,id,cd){
        ...
        let obj = new FormData();
        obj.append("admin_token",token);
        obj.append("store_class_id",id);
        obj.append("update",0);
        fetch(urlhttp+"/admin.shop_store_class/editone",{method:"post",body:obj})
            .then(function(response){
                return response.json();
            }).then(function(result){
                if(result.error == ""){
    ...
    onEditorOk:function(token,values,Actions,cb){
        ...
        let obj = new FormData();
        obj.append("admin_token",token);
        obj.append("store_class_id",values["store_class_id"]);
        obj.append("store_class_name",values["store_class_name"]);
        obj.append("store_class_bail",values["store_class_bail"]);
        obj.append("sort_order", values["sort_order"]);
        obj.append("update",1);
